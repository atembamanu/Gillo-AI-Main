...
/**
 * Parse postgresql://user:password@host:port/db so passwords with !, ^, @, etc.
 * are not misread by libpq URI parsing (same rules as scripts/seed_initial_data.py).
 */
...
/**
 * Prefer POSTGRES_PASSWORD + POSTGRES_HOST/… when set; otherwise parse POSTGRES_URL safely.
 */
